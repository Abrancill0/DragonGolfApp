...
import { actionSignIn, actionLoading, actionLanguage, actionSignInError, actionSetForceInset } from '../../../store/actions';
...
const mapStateToProps = state => ({
    ...
    signInError: state.reducerSignInError,
});
...
const mapDispatchToProps = dispatch => ({
    ...
    resetSignInError: () => {
        dispatch(actionSignInError(false));
    },
    setForceInset: (value) => {
