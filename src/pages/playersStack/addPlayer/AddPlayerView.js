  ...
  searchFilterFunction = (text,busqueda) => {
   ...
   renderSeparator = () => {  
    ...
    return (
      ...
      <SearchBar
        placeholder={name[this.state.language]}
      ...
      />
      <SearchBar
        placeholder={lastName[this.state.language]}
      ...
      />
      <SearchBar
        placeholder={nickname[this.state.language]}
        lightTheme
        round
      ...
      />
      <SearchBar
        placeholder={email[this.state.language]}
        lightTheme
        round
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <Text style={{ padding:20, fontSize: 16, fontFamily: 'BankGothic Lt BT',alignSelf:'center' , color:Colors.Primary,fontWeight:'bold'}}>{allPlayersView[language]}</Text>
          </View>
          {/*<View style={{ flex: 0.3, justifyContent: 'flex-end' }}>
