                    ...
                    <View style={styles.scoreView} key={index}>
                        ...
                        <View style={styles.holesView}>
                            ...
                            <View style={styles.strokesTotalView}>
                                {TotalScore[index]>0?<Text style={styles.strokesTotal}>{TotalScore[index]}</Text>:<Text style={styles.strokesTotal}></Text>}
                                {TotalScoreGP[index]>0?<Text style={styles.strokesTotalAdv}>{TotalScoreGP[index]}</Text>:<Text style={styles.strokesTotalAdv}></Text>}
                            </View>
                        </View>
                    </View>)
                }
