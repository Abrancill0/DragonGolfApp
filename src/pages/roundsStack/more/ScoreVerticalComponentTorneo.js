        ...
        switch(parseInt(hole)){
            ...
            case 12:
                for (var i = 0 ; i <= this.props.holeInfo.length - 1; i++) {
                    ...
                    b9HA.push([this.props.holeInfo[i]['Ho_Advantage3'], this.props.holeInfo[i]['Ho_Advantage4'], this.props.holeInfo[i]['Ho_Advantage5'], this.props.holeInfo[i]['Ho_Advantage6'], this.props.holeInfo[i]['Ho_Advantage7'], this.props.holeInfo[i]['Ho_Advantage8'], this.props.holeInfo[i]['Ho_Advantage9'], this.props.holeInfo[i]['Ho_Advantage10'], this.props.holeInfo[i]['Ho_Advantage11']])
                    ...
                    <View style={styles.scoreView} key={index}>
                        ...
                        <View style={styles.holesView}>
                            {f9H[index].map((holeIndex, i) =>
                                <View key={i}>
                                    {f9HA[index][i]>0?<Text style={styles.advText}>{f9HA[index][i]}</Text>:<Text style={styles.advText}></Text>}
                                    <View
                            ...
                            <View style={styles.strokesTotalView}>
                                {ScoreIn[index]>0?<Text style={styles.strokesTotal}>{ScoreIn[index]}</Text>:<Text style={styles.strokesTotal}></Text>}
                                {ScoreInGP[index]>0?<Text style={styles.strokesTotalAdv}>{ScoreInGP[index]}</Text>:<Text style={styles.strokesTotalAdv}></Text>}
                            </View>
                        </View>
                    </View>)
                }
                    ...
                    <View style={styles.holesView}>
                        {item.map((item2,index2) =>
                            <View  style={styles.holeInfoView}>
                                <Text numberOfLines={1} adjustsFontSizeToFit style={[styles.holeNumber,{fontSize: 13}]}>{TeeNumberB[index2]}</Text>
                                <Text
                                        key={index2}
                                        style={styles.parNumber}
                                    >
                    ...
                    <View style={styles.scoreView} key={index}>
                        ...
                        <View style={styles.holesView}>
                            {b9H[index].map((holeIndex, i) =>
                                <View key={i}>
                                    {b9HA[index][i]>0?<Text style={styles.advText}>{b9HA[index][i]}</Text>:<Text style={styles.advText}></Text>}
                            ...
                            <View style={styles.strokesTotalView}>
                                {ScoreOut[index]>0?<Text style={styles.strokesTotal}>{ScoreOut[index]}</Text>:<Text style={styles.strokesTotal}></Text>}
                                {ScoreOutGP[index]>0?<Text style={styles.strokesTotalAdv}>{ScoreOutGP[index]}</Text>:<Text style={styles.strokesTotalAdv}></Text>}
                            </View>
                        </View>
                    </View>)
                }
