...
export default class ScoreVerticalComponent extends Component {
    ...
    renderPressTable = (holes, pressesArray, type) => {
        ...
        console.log('========= advTotalStrokes ====', advTotalStrokes);
        console.log('pressesArray: ', pressesArray);
        ...
        const havePress = pressesArray != undefined ? pressesArray[0].filter(press => press === null).length !== 9 : false;
