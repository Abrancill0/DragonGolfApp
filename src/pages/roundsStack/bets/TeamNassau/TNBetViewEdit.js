...
class SNBetView extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      playerA:this.props.route.params.Player1.toString(),
      playerB:this.props.route.params.Player2.toString(),
      playerC:this.props.route.params.Player3.toString(),
      playerD:this.props.route.params.Player4.toString(),
      language: '',
      players: [],
