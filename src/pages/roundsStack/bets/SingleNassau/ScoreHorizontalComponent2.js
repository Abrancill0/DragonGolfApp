...
export default class ScoreHorizontalComponent extends Component {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                {holeInfo.map((item, index) =>
                    <View style={styles.scoreView} key={index.toString()}>
                        <View style={styles.holeTextView}>
    ...
    renderPressTable = (holes, pressesArray) => {
        ...
        const havePress = (pressesArray.front9[0].filter(press => press === null).length + pressesArray.back9[0].filter(press => press === null).length) !== 18;
